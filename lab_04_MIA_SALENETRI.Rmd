...
#actavis seems highly concentrated at the top. Actavis -> miami-luken -> tug valley pharmacy, llc claimed the top spot
```
...
mingo %>%
  group_by(reporter_name, reporter_dea_no, reporter_address1, reporter_city) %>%
...
My answer: I want to be able to group together data points that have the word "cardinal" in the reporter_name column and create one possible input for them all to become ?
