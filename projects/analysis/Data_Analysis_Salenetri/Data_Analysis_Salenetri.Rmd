...
Let's add some BLS OES data

```{r}
unemployment06 <- read_csv('BLS_Data/laucnty06.csv')
unemployment07 <- read_csv('BLS_Data/laucnty07.csv')
unemployment08 <- read_csv('BLS_Data/laucnty08.csv')
unemployment09 <- read_csv('BLS_Data/laucnty09.csv')
unemployment10 <- read_csv('BLS_Data/laucnty10.csv')
unemployment11 <- read_csv('BLS_Data/laucnty11.csv')
unemployment12 <- read_csv('BLS_Data/laucnty12.csv')
```

need to change the state & county fips in the unemployment data so i can join it with everything else
```{r}
test_unemployment06 <- unemployment06 %>%
  format(state_fips, digits ='2')
