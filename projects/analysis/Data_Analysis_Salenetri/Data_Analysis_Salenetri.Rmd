...
try to make a cluster plot with multiple factors
this ones: rural/urban code, pills per person, median income
```{r}
...
ggplot(big_data, aes(med_income, Pills_per_person, col=RUCC_2013)) + 
  geom_point(aes(shape=RUCC_2013), size=2) +   # draw points
  labs(title="Title", 
       subtitle="subtitle",
       caption="Source")

# Plot ----------------------------------------------------
ggplot(big_data, aes(x=median_income, y=Pills_per_person)) + 
  geom_point(aes(col=RUCC_2013)) + 
